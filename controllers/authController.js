...
exports.protect = catchAsync(async (req, res, next) => {
	...
	// Display user data on rendered website
...
exports.restrictTo = (...roles) => {
	return (req, res, next) => {
		// roles is an array, e,g, ['admin', 'lead-guid']
...
exports.resetPassword = catchAsync(async (req, res, next) => {
	...
	// and there is a user associated with this token,
	// reset the password
	if (!user)
		return next(
	...
	//    Use pre-save middleware in userModel.js
